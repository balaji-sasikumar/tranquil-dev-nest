...
const Home: React.FC = () => {
  ...
  const projects = [
    {
      title: 'File Explorer',
      description: 'A desktop file explorer that allows secure file storage in Azure File Share with encryption.',
      technologies: ['Electron', 'React', 'Material-UI'],
      features: ['Drag & Drop', 'File Previews', 'Encrypted Storage', 'Modern UI']
    },
    {
      title: 'TaskManager',
      description: 'A task and event management system improving team collaboration by 60%.',
      technologies: ['Node.js', 'MongoDB', 'Azure'],
      features: ['Realtime updates', 'Notifications', 'Secure file uploads']
    },
    {
      title: 'Secure Notes App',
      description: 'A notes app with end-to-end encryption, handling 1000+ file uploads daily.',
      technologies: ['Node.js', 'Firebase', 'AES Encryption'],
      features: ['File encryption', 'Password protection', 'Cloud sync']
    },
    {
      title: 'B-Dash',
      description: 'Developed a logging and rule engine system for recalculating business logic.',
