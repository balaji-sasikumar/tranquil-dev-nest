...
const SkillItem: React.FC<SkillItemProps> = ({
  ...
  const getSkillIcon = (skillName: string) => {
    switch (skillName) {
      ...
      case "TypeScript":
        return (
          <i className="devicon-typescript-plain colored text-2xl mr-3"></i>
        );
      case "Python":
      ...
      case "JavaScript":
        return (
          <i className="devicon-javascript-plain colored text-2xl mr-3"></i>
        );
      ...
      case "Angular":
        return (
          <i className="devicon-angularjs-plain colored text-2xl mr-3"></i>
        );
      case "Ionic":
        return <i className="devicon-ionic-original colored text-2xl mr-3"></i>;
      case "Electron":
        return (
          <i className="devicon-electron-original colored text-2xl mr-3"></i>
        );

      // Web Technologies
      case "Bootstrap":
        return (
          <i className="devicon-bootstrap-plain colored text-2xl mr-3"></i>
        );
      case "Tailwind CSS":
        return (
          <i className="devicon-tailwindcss-plain colored text-2xl mr-3"></i>
        );
      case "Material-UI":
        return (
          <i className="devicon-materialui-plain colored text-2xl mr-3"></i>
        );
      ...
      case "Kubernetes":
        return (
          <i className="devicon-kubernetes-plain colored text-2xl mr-3"></i>
        );
      ...
      default:
        return (
          <i className="devicon-github-original colored text-2xl mr-3"></i>
        );
    }
  };
